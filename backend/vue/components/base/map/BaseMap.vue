...
export default {
    ...
    mixins: [geocoder],
    emits: ['beforeBalloonOpen', 'update:zoom', 'error', 'pickPvz'],
    props: {
        startCenter: {
            type: Array,
    ...
    methods: {
        ...
        pickPvz(point) {
            this.coords = [point.latitude, point.longitude]
            this.$emit('pickPvz', point)
        }
    }
}
</script>
