...
<form action="#" class="popup__inputs-wrapper js-form-right b-tab <?=$activeTab == 2 ? 'active' : 'disabled';?>" id="registration" data-type="registr">
    <div class="popup__tabs-input">
        <input class="popup__input-email input" type="email" name="email" id="popup-email" placeholder="Почта*" required>
    </div>
